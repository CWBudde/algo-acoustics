...
The repository includes a 60-point finite-wedge series generated by the
official EDB2 frequency-domain implementation for these RAVEN dimensions. The
generator, numeric CSV, hashes, and runtime provenance are tracked in
[`testdata/diffraction`](../testdata/diffraction/README.md); the dissertation's
plots were not digitized.
